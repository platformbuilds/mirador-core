...
func (f *fakeSchemaRepo) UpsertMetric(_ context.Context, m repo.MetricDef, _ string) error {
    ...
    if f.metrics == nil { f.metrics = map[string]repo.MetricDef{} }
...
func (*fakeSchemaRepo) ListMetricVersions(_ context.Context, _, _ string) ([]repo.VersionInfo, error) { return nil, errors.New("not implemented") }
...
func (*fakeSchemaRepo) UpsertMetricLabel(_ context.Context, _, _, _, _ string, _ bool, _ map[string]any, _ string) error { return errors.New("not implemented") }
func (*fakeSchemaRepo) GetMetricLabelDefs(_ context.Context, _, _ string, _ []string) (map[string]*repo.MetricLabelDef, error) {
    return nil, errors.New("not implemented")
}
func (*fakeSchemaRepo) UpsertLogField(_ context.Context, _ repo.LogFieldDef, _ string) error { return errors.New("not implemented") }
func (*fakeSchemaRepo) GetLogField(_ context.Context, _, _ string) (*repo.LogFieldDef, error) { return nil, errors.New("not implemented") }
func (*fakeSchemaRepo) ListLogFieldVersions(_ context.Context, _, _ string) ([]repo.VersionInfo, error) { return nil, errors.New("not implemented") }
func (*fakeSchemaRepo) GetLogFieldVersion(_ context.Context, _, _ string, _ int64) (map[string]any, repo.VersionInfo, error) {
    return nil, repo.VersionInfo{}, errors.New("not implemented")
}
func (*fakeSchemaRepo) UpsertTraceServiceWithAuthor(_ context.Context, _, _, _, _ string, _ []string, _ string) error { return errors.New("not implemented") }
func (*fakeSchemaRepo) GetTraceService(_ context.Context, _, _ string) (*repo.TraceServiceDef, error) { return nil, errors.New("not implemented") }
func (*fakeSchemaRepo) ListTraceServiceVersions(_ context.Context, _, _ string) ([]repo.VersionInfo, error) { return nil, errors.New("not implemented") }
func (*fakeSchemaRepo) GetTraceServiceVersion(_ context.Context, _, _ string, _ int64) (map[string]any, repo.VersionInfo, error) {
    return nil, repo.VersionInfo{}, errors.New("not implemented")
}
func (*fakeSchemaRepo) UpsertTraceOperationWithAuthor(_ context.Context, _, _, _, _, _ string, _ []string, _ string) error { return errors.New("not implemented") }
func (*fakeSchemaRepo) GetTraceOperation(_ context.Context, _, _, _ string) (*repo.TraceOperationDef, error) { return nil, errors.New("not implemented") }
func (*fakeSchemaRepo) ListTraceOperationVersions(_ context.Context, _, _, _ string) ([]repo.VersionInfo, error) { return nil, errors.New("not implemented") }
