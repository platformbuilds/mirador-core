...
func (c *fakeCache) GetSession(ctx context.Context, sessionID string) (*models.UserSession, error) {
	return nil, nil
}
...
func (c *fakeCache) GetCachedQueryResult(ctx context.Context, queryHash string) ([]byte, error) {
	return nil, nil
}
