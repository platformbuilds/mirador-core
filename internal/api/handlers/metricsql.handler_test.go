...
func (c *memCache) GetSession(ctx context.Context, sessionID string) (*models.UserSession, error) {
	return nil, nil
}
...
func (c *memCache) GetActiveSessions(ctx context.Context, tenantID string) ([]*models.UserSession, error) {
	return nil, nil
}
