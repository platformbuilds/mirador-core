...
func (stubSchemaRepo) UpsertMetric(ctx context.Context, m repo.MetricDef, author string) error { return nil }
...
func (stubSchemaRepo) UpsertLogField(ctx context.Context, f repo.LogFieldDef, author string) error { return nil }
...
func TestServer_AuthOn_And_SchemaRegistered(t *testing.T) {
    ...
    if r2.StatusCode != http.StatusUnauthorized { t.Fatalf("expected 401, got %d", r2.StatusCode) }
