...
func TestValidateKPIDefinition_Failures(t *testing.T) {
	...
	// Invalid layer
	k1 := &models.KPIDefinition{Name: "x", Layer: "invalid", SignalType: "metrics", Sentiment: "negative", Dashboard: "123e4567-e89b-52d3-a456-426614174000"}
	...
	// Invalid signalType
	k2 := &models.KPIDefinition{Name: "x2", Layer: "cause", SignalType: "metrix", Sentiment: "negative", Classifier: "errors", Domain: "d", Dashboard: "123e4567-e89b-52d3-a456-426614174000"}
	...
	// Invalid sentiment
	k3 := &models.KPIDefinition{Name: "x3", Layer: "impact", SignalType: "metrics", Sentiment: "BAD", BusinessImpact: "biz", Dashboard: "123e4567-e89b-52d3-a456-426614174000"}
	...
	k4 := &models.KPIDefinition{Name: "x4", Layer: "cause", SignalType: "metrics", Sentiment: "negative", Classifier: "latency", Datastore: "victoriametrics", QueryType: "sql", Formula: "select 1", Domain: "d", Dashboard: "123e4567-e89b-52d3-a456-426614174000"}
	...
	k5 := &models.KPIDefinition{Name: "x5", Layer: "impact", SignalType: "metrics", Sentiment: "negative", Dashboard: "123e4567-e89b-52d3-a456-426614174000"}
	...
	k6 := &models.KPIDefinition{Name: "x6", Layer: "cause", SignalType: "metrics", Sentiment: "negative", Domain: "payments", Dashboard: "123e4567-e89b-52d3-a456-426614174000"}
	...
	k7 := &models.KPIDefinition{Name: "x7", Layer: "cause", SignalType: "metrics", Sentiment: "negative", Classifier: "errors", Datastore: "victoriametrics", QueryType: "MetricsQL", Dashboard: "123e4567-e89b-52d3-a456-426614174000"}
...
func TestValidateKPIDefinition_DatastoreQueryCombinations(t *testing.T) {
	...
	a := &models.KPIDefinition{Name: "d1", Layer: "cause", SignalType: "metrics", Sentiment: "negative", Classifier: "latency", Datastore: "victoriametrics", Dashboard: "123e4567-e89b-52d3-a456-426614174000"}
	...
	b := &models.KPIDefinition{Name: "d2", Layer: "cause", SignalType: "metrics", Sentiment: "negative", Classifier: "errors", QueryType: "MetricsQL", Dashboard: "123e4567-e89b-52d3-a456-426614174000"}
	...
	c := &models.KPIDefinition{Name: "d3", Layer: "cause", SignalType: "metrics", Sentiment: "negative", Classifier: "latency", Datastore: "victoriametrics", QueryType: "MetricsQL", Formula: "x", Dashboard: "123e4567-e89b-52d3-a456-426614174000"}
